    ...
    <div className="min-h-screen grid place-items-center p-6">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={submit} className="bg-slate-900/60 p-6 rounded-2xl border border-slate-800">
          <FormInput label="Ism" value={name} onChange={setName} placeholder="Oyatullokh" />
          ...
          <FormInput label="Parol" value={password} onChange={setPassword} type="password" placeholder="Kamida 8 belgi" />
          <Button type="submit">Ro‘yxatdan o‘tish</Button>
          <div className="text-sm mt-4">
            <Link to="/login" className="text-indigo-400 hover:underline">Allaqachon akkauntim bor</Link>
          </div>
        </form>
      </div>
    </div>
